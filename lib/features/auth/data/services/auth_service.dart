...
batch.set(userRef, {
  ...
  Future<bool> checkUsernameAvailability(String username) async {
    try {
      ...
      // Permission hatası durumunda (kayıt sırasında) true döndür
      // Kayıt sırasında zaten Firestore transaction ile kontrol edilecek
      if (e.toString().contains('permission-denied')) {
        return true; // Kullanılabilir varsay, kayıt sırasında kontrol edilecek
      }
      return false;
    }
  }
